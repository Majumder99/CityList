...
public class MainActivityTest {
    ...
    public void UItest()
    {
        ...
        onView(withId(R.id.button_add)).perform(click()); //Click add button to add a city to the list
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Savar")); //Type a city name
        Espresso.pressBack();
        onView(withId(R.id.button_confirm)).perform(click());

        onView(withId(R.id.button_add)).perform(click()); //Click add button to add a city to the list
        onView(withId(R.id.editText_name)).perform(ViewActions.typeText("Barisal")); //Type a city name
        Espresso.pressBack();
        onView(withId(R.id.button_confirm)).perform(click());
        ...
        onView(withText("Barisal")).check(matches(isDisplayed()));
